-- Final Cloud Migration Script for FoodTruck Hub
...
-- Step 7: Create sample bookings (without vendor_notes and venue_owner_notes)
INSERT INTO public.bookings (
  id, listing_id, vendor_id, booking_date, start_time, end_time, 
  total_hours, total_cost, status, payment_status, cancellation_reason
) VALUES 
(uuid_generate_v4(), '11111111-1111-1111-1111-111111111111', '660e8400-e29b-41d4-a716-446655440001', CURRENT_DATE - INTERVAL '5 days', '11:00', '16:00', 5, 125.00, 'completed', 'paid', NULL),
(uuid_generate_v4(), '22222222-2222-2222-2222-222222222222', '660e8400-e29b-41d4-a716-446655440002', CURRENT_DATE - INTERVAL '3 days', '12:00', '18:00', 6, 120.00, 'completed', 'paid', NULL),
(uuid_generate_v4(), '33333333-3333-3333-3333-333333333333', '660e8400-e29b-41d4-a716-446655440003', CURRENT_DATE - INTERVAL '1 day', '17:00', '22:00', 5, 110.00, 'completed', 'paid', NULL),
(uuid_generate_v4(), '11111111-1111-1111-1111-111111111111', '660e8400-e29b-41d4-a716-446655440002', CURRENT_DATE + INTERVAL '2 days', '11:00', '16:00', 5, 125.00, 'confirmed', 'paid', NULL),
(uuid_generate_v4(), '44444444-4444-4444-4444-444444444444', '660e8400-e29b-41d4-a716-446655440001', CURRENT_DATE + INTERVAL '5 days', '12:00', '18:00', 6, 168.00, 'confirmed', 'paid', NULL),
(uuid_generate_v4(), '55555555-5555-5555-5555-555555555555', '660e8400-e29b-41d4-a716-446655440003', CURRENT_DATE + INTERVAL '7 days', '10:00', '16:00', 6, 180.00, 'pending', 'pending', NULL)
ON CONFLICT (id) DO NOTHING; 