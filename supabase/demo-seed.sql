-- Demo Seed Data for FoodTruck Hub
-- This creates sample data for a compelling demo

-- First, create auth users (these need to exist in auth.users first)
...
INSERT INTO public.vendor_profiles (user_id, business_name, business_type, verification_status) VALUES
('660e8400-e29b-41d4-a716-446655440001', 'Carlos Tacos', 'food_truck', 'verified'),
('660e8400-e29b-41d4-a716-446655440002', 'Toms Burger Joint', 'food_truck', 'verified'),
('660e8400-e29b-41d4-a716-446655440003', 'Marcos Pizza Express', 'food_truck', 'verified')
ON CONFLICT (user_id) DO NOTHING;
...
INSERT INTO public.listings (
  ...
  (
    ...
    'Royal Mile Food Festival',
    'Historic location on Edinburgh''s Royal Mile. Tourist hotspot with excellent visibility and foot traffic.',
    'Royal Mile',
    'Edinburgh',
    'Scotland',
    'EH1 1RE',
