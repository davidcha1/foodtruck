-- Migration script to move data from local Docker to Supabase Cloud
-- This script exports the sample data we created locally

-- Export users (auth.users and public.users)
-- Note: We'll need to handle auth.users separately via Supabase dashboard

-- Export venue owner profiles
