-- Cloud Migration Script for FoodTruck Hub
-- Run this in your Supabase dashboard SQL editor

-- First, let's create the users in auth.users (you'll need to do this manually via dashboard)
-- Then create the corresponding public.users records

-- Create public user records for venue owners
